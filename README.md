...
| `<Space>w` | ファイル保存                           |
| `<Space>e` | ファイルツリーにフォーカス（neo-tree） |
| `<Space>E` | ファイルツリーをトグル                 |
...
| キー             | 説明                                       |
| ---------------- | ------------------------------------------ |
| `<Space><Space>` | ファイル検索（Git 内なら追跡ファイルのみ） |
| `<Space>ff`      | 同上                                       |
| `<Space>fF`      | 全ファイル検索（重い・モノレポでは遅い）   |
...
| `<Space>a` | エージェントパネルを開く/閉じる（右側 40%） |
| `Esc`      | ターミナルモードから抜ける                  |
| `jk`       | ターミナルモードから抜ける                  |
...
| `c`     | コピー                          |
| `m`     | 移動                            |
| `<`     | 前のソース（Files/Buffers/Git） |
| `>`     | 次のソース（Files/Buffers/Git） |
| `?`     | ヘルプ表示                      |
